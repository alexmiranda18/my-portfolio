...
import { AnimatedBackground } from "../../../../components/AnimedBackground/AnimatedBackground";
                ...
                <Container>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} md={7}>
                            <Typography color="primary.contrastText" variant="h1" textAlign="center" pb={2}>Alex Miranda</Typography>
